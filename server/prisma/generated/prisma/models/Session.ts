...
export type SessionWhereInput = {
  ...
  expire_at?: Prisma.DateTimeFilter<"Session"> | Date | string
...
export type SessionScalarWhereWithAggregatesInput = {
  ...
  expire_at?: Prisma.DateTimeWithAggregatesFilter<"Session"> | Date | string
}
...
export type SessionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"user_id" | "token_hash" | "expire_at", ExtArgs["result"]["session"]>
...
export interface SessionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const sessionWithUser_idOnly = await prisma.session.findMany({ select: { user_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Sessions and only return the `user_id`
   * const sessionWithUser_idOnly = await prisma.session.createManyAndReturn({
   *   select: { user_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Sessions and only return the `user_id`
   * const sessionWithUser_idOnly = await prisma.session.updateManyAndReturn({
   *   select: { user_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SessionFieldRefs {
  ...
  readonly expire_at: Prisma.FieldRef<"Session", 'DateTime'>
}
